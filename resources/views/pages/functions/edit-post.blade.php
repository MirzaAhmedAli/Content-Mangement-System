...
<nav class=" border-gray-200 shadow-lg">
  ...
  <div class="editor max-w-4xl px-6 py-2 mx-auto w-11/12 flex flex-col text-gray-800 border border-gray-300 rounded-lg p-4 shadow-lg justify-start text-left">
      ...
      <textarea class="description bg-gray-100 sec p-3 h-60 border rounded-lg border-gray-300 outline-none" spellcheck="false" placeholder="Rev your thoughts here..." name="description" value="{{$post->description}}"></textarea>
